...
urlpatterns = [
    ...
    path('add_staff_rg/<id>/',HodViews.add_stuff_rg_save,name="add_staff_rg"),
    path('add_stuff_rg_delete/<id>/',HodViews.add_stuff_rg_delete,name="add_stuff_rg_delete"),
    ...
    path('staff_view_attendance_list', StaffViews.staff_view_attendance_list, name="staff_view_attendance_list"),
